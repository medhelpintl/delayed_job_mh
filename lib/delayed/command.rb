  ...
  class Command
    ...
    def initialize(args)
      ...
      opts = OptionParser.new do |opts|
        ...
        opts.on('--priority p', 'Priority of jobs to run.') do |n|
          @options[:priority] = n
        end
        opts.on('--batch-size b', 'Batch size to handle jobs.') do |n|
    ...
    def daemonize
      ...
      unless @options[:priority]
        raise ArgumentError, 'Must specify a priority (use --priority p)'
      end
